...
Обязательное дополнение к неделям 6-7, 11 и 16. Транзакции изучаются через timeline нескольких сессий: **пока аномалия не воспроизведена руками, определение считается неусвоенным.**
...
- [ ] **6. Параллельные переводы и проверка инварианта суммы.** `Weak7` и `Weak16`: тесты на 50 конкурентных переводов на настоящем PostgreSQL.
